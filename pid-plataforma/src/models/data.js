...
export const PERSONA_CONFIG = {
  ...
  governo: {
    ...
    icon:  "🏛️",
    cor:   "#34D399",
    ctaLabel: "Ver políticas públicas",
    camadasInfraAtivas: ["uhe", "eolica", "solar", "se500", "curtailment"],
    bannerTitulo: "Modo Governo",
    bannerTexto:  "Dados territoriais para políticas públicas e metas de descarbonização.",
    bannerCor:      "#34D399",
    bannerCorTexto: "#065f46",
    kpiPrincipalLabel: "Potencial Renovável",
    kpiPrincipalValor: () => "~95 GW",
    kpiPrincipalSub:   "Capacidade instalada — ANEEL 2024",
  },
  consultor: {
    ...PERSONA_DEFAULT,
    ...
    camadasInfraAtivas: ["uhe", "pch", "eolica", "solar", "biomassa", "se500", "lt500"],
    camadasPIDAtivas: ["pid_eol", "pid_sol", "pid_hid", "pid_freq", "pid_tens"],
    bannerTitulo: "Modo Consultor Técnico",
    bannerTexto:  "Camadas técnicas detalhadas, indicadores setoriais e dados de infraestrutura.",
    bannerCor:      "#FF8C69",
    bannerCorTexto: "#7c2d12",
    kpiPrincipalLabel: "Pontos Mapeados",
    kpiPrincipalValor: () => "3.278",
    kpiPrincipalSub:   "Usinas e subestações — ANEEL/ONS",
  },
  cidadao: {
    ...PERSONA_DEFAULT,
    label: "Cidadão",
    icon:  "🌱",
    cor:   "#86EFAC",
    ctaLabel: "Saiba mais sobre transição energética",
    camadasInfraAtivas: ["uhe", "eolica", "solar"],
    bannerTitulo: "Modo Cidadão",
    bannerTexto:  "Entenda como a transição energética impacta sua cidade e o futuro do Brasil.",
    bannerCor:      "#86EFAC",
    bannerCorTexto: "#14532d",
    kpiPrincipalLabel: "Energia Renovável",
    kpiPrincipalValor: () => "89%",
    kpiPrincipalSub:   "Da matriz elétrica brasileira",
  },
};